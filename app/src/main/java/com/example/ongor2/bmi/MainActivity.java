package com.example.ongor2.bmi;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void calBMI(){
        ...
        EditText texth = (EditText)findViewById(R.id.editText2_height);
